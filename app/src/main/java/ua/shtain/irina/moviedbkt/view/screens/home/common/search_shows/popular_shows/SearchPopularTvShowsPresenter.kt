 ...
 */
class SearchPopularTvShowsPresenter @Inject constructor(compositeDisposable: CompositeDisposable,
    ...
    override fun getShows(page: Int) = mModel.searchPopularShows(page)
}