 ...
 */
class SearchOnAirTvShowsPresenter @Inject constructor(compositeDisposable: CompositeDisposable,
    ...
    override fun getShows(page: Int) = mModel.searchTvOnTheAir(page)
}